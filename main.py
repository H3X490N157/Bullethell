...
def GameStart():
	...
	spr_gi = load_sprite('spr_gi.png').convert_alpha()
	spr_jm = load_sprite('spr_jm.png').convert_alpha()
	spr_la = load_sprite('spr_la.png').convert_alpha()
	spr_zv = load_sprite('spr_zv.png').convert_alpha()
	...
	class Player(pygame.sprite.Sprite):
		...
		def cleancircle(self, duration):
			for i in range(36):
				cc = CleanBullet(self.rect.centerx, self.rect.centery, 10 * ii, 2, duration)
	...
	class Title(pygame.sprite.Sprite):
		def __init__(self, pj, side):
			...
			self.moveOut=False; self.lastMoveOut=pygame.time.get_ticks()
		def update(self):
			now=pygame.time.get_ticks()
